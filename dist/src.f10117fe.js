...
var initialH1Text = (_a = h1Element === null || h1Element === void 0 ? void 0 : h1Element.innerText) !== null && _a !== void 0 ? _a : 'Tic Tac Toe!';
var ROW_COUNT = 3;
var COL_COUNT = 3;
...
function checkIfWinnerExists(row, col, moveAtCell) {
  var verticalCheck = boardState.reduce(function (movesArr, _, currRowIndex, arr) {
    movesArr.push(arr[currRowIndex][col]);
    return movesArr;
  }, []);
  var horizontalCheck = boardState[row];
  var diagonalCheck1 = boardState.reduce(function (movesArr, _, currRowIndex, arr) {
    var currColumn = currRowIndex;
    movesArr.push(arr[currRowIndex][currColumn]);
    return movesArr;
  }, []);
  var diagonalCheck2 = boardState.reduce(function (movesArr, _, currRowIndex, arr) {
    var currColumn = Math.abs(currRowIndex - (arr.length - 1));
    movesArr.push(arr[currRowIndex][currColumn]);
    return movesArr;
  }, []);
  var hasWonInSomeWay = [verticalCheck, horizontalCheck, diagonalCheck1, diagonalCheck2].some(function (movesArr) {
    return movesArr.every(function (recordedMove) {
...
function setCurrentMove() {
  ...
  var moveElement = document.getElementById('move-element');
